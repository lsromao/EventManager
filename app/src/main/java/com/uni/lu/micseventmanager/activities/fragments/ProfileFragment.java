...
public class ProfileFragment extends Fragment implements View.OnClickListener {
	...
	public View onCreateView(@NonNull LayoutInflater inflater,
		...
		iconCancel = root.findViewById(R.id.profileIconCancel);
	...
	private void loadProfile() {
		...
		if (picture.equals("")) {
			GlideApp.with(this)
					...
					.into(profilePic);
		} else if(picture.contains("gs://eventmanager-misc.appspot.com")) {
	...
	public void onClick(View v) {
		switch (v.getId()) {
			...
			case R.id.iconEditProfilePic:
				Intent storage = gallery.pickFromGallery(getActivity());
				if (storage != null){
